...
void OscilloscopePlot::setIntervalLength( double interval )
{
...
void OscilloscopePlot::resizeEvent( QResizeEvent *event )
{
    d_directPainter->reset();
    QwtPlot::resizeEvent( event );
}

void OscilloscopePlot::showEvent( QShowEvent * )
{
    replot();
}

bool OscilloscopePlot::eventFilter( QObject *object, QEvent *event )
{
    if ( object == canvas() && 
