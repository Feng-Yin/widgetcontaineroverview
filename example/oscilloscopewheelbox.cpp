...
class OscilloscopeWheel: public QwtWheel
{
public:
    OscilloscopeWheel( OscilloscopeWheelBox *parent ):
        QwtWheel( parent )
    {
...
OscilloscopeWheelBox::OscilloscopeWheelBox( const QString &title,
    ...
    QWidget( parent )
{
    ...
    d_wheel = new OscilloscopeWheel( this );
...
void OscilloscopeWheelBox::setTheme( const QColor &color )
{
    d_wheel->setPalette( color );
}

QColor OscilloscopeWheelBox::theme() const
{
    return d_wheel->palette().color( QPalette::Window );
}

void OscilloscopeWheelBox::setValue( double value )
{
    d_wheel->setValue( value );
    d_number->display( value );
}

double OscilloscopeWheelBox::value() const
{
